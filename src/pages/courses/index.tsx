...
const CoursesPage = () => {
  ...
  const { data } = useFetch<Response>(url);
    ...
    return (
        ...
        <div className="relative before:absolute before:h-[45%] before:z-[-2] before:top-0 before:left-0 before:w-full after:absolute after:top-1/2 after:left-1/2 after:-translate-x-2/4 after:-translate-y-2/4 after:mix-blend-luminosity">
          ...
          <div className="bg-[#f5f5f5]">
            <div className="md:mx-auto md:px-[15px] m-0 p-0 flex flex-col justify-center items-center md:w-[88%] w-full md:pb-[140px] pb-[65px] ">
                <div className="max-w-3xl box-border rounded-lg md:mt-[-50px] mt-[-50px] md:mb-[75px] mb-11 z-[1] bg-gradient-to-r from-[#ecd5b4] to-[#b39569] md:pt-10 md:pb-[32px] md:px-[45px] p-5">
                    ...
                    <div className="box-border w-full max-w-full flex-shrink-0 md:w-1/3 lg:w-1/3 pr-[calc(var(--bs-gutter-x)_/_2)] pl-[calc(var(--bs-gutter-x)_/_2)] mt-[var(--bs-gutter-y)]">
                        <select
                        className="mb-6 box-border block w-full rounded-lg bg-white bg-no-repeat text-center align-middle text-base font-normal normal-case font-[inherit] leading-[normal] text-[rgba(99,99,99,1)] bg-[16px_12px]"
                        name="id_category"
                        >
                        <option
                            className="box-border text-base font-light text-[rgba(112,112,112,1)]"
                    ...
                    <div className="box-border flex flex-col items-center ">
                        <div className="-mt-0 box-border w-full max-w-full flex flex-col items-center flex-shrink-0">
                            ...
                            <button
                                className="box-border rounded-3xl text-center md:text-base font-medium normal-case tracking-normal open:cursor-pointer font-[inherit] leading-[inherit] md:min-w-[140px] min-w-[110px] bg-[var(--global-color-primary)] text-white md:p-2 py-[7px] px-[12px] md:text-[18px] text-sm border-2 border-white"
                                type="submit"
                            >
                                <FontAwesomeIcon
                ...
                <div className="box-border w-full max-w-full flex-shrink-0 flex flex-col items-center">
                    <h2 className="relative float-none mt-0 md:mb-11 mb-8 box-border table text-center text-2xl font-medium tracking-wide xl:text-3xl leading-[normal] text-[rgba(17,17,17,1)] underline decoration-sky-500 underline-offset-8 ">
                    กฎหมาย
                    </h2>
                </div>
                ...
                <div className="mx-auto container md:mt-24 mt-12 flex flex-col items-center">
                  <Pagination
                    page={parseInt(page)}
