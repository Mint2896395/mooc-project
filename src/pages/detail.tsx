...
const Detail = () => {
  return (
    <>
                ...
                <div className="box-border ">
                  <div className="box-border flex flex-wrap ">
                    <div className="box-border w-full max-w-full flex-shrink-0 ">
                      <h4 className="mb-2 mt-0 box-border text-2xl font-medium leading-[normal] tracking-wide text-[rgba(17,17,17,1)]  xl:text-2xl">
                  ...
                  <div className="box-border flex flex-wrap ">
                    <div className="box-border w-full max-w-full flex-shrink-0 ">
                      <h6 className="mb-5 mt-0 box-border font-[Sarabun,_sans-serif] text-lg font-semibold leading-[normal] tracking-normal text-[rgba(17,17,17,1)]">
                        ลงทะเบียนเรียน
                      </h6>
                    </div>
                  </div>
      ...
      <div className="px-10 pt-10 md:flex">
        ...
        <div className="box-border ">
          ...
          >
            <FontAwesomeIcon
              icon={faArrowLeft}
              style={{ width: "10px" }}
              className="box-border inline-block not-italic leading-none text-[rgba(200,0,114,1)]"
            />
            &nbsp;&nbsp;ย้อนกลับ
          </Link>
        </div>
