...
const Home: NextPage = () => {
  return (
    <>
      ...
      <div className="flex flex-col items-center py-[50px] md:py-20">
        <div className="mb-5 flex flex-col text-center md:flow-root md:w-[88%] md:px-[15px]">
          <h2 className="mb-3 mt-0 box-border table text-xl font-medium leading-[normal] tracking-wide text-[rgba(17,17,17,1)] decoration-sky-500 underline-offset-8 md:float-left md:mb-11 md:pl-10 md:text-3xl md:underline xl:text-3xl">
            คอร์สที่กำลังเปิด
          </h2>
          <BackButton
            href="/courses"
